        ...
        link: function ($scope, $element, $attributes) {
            ...
            $scope.searchFilter = function (s) {
                if ($scope.search === '') {
                    ...
                    if (s.series && s.series.toLowerCase().indexOf($scope.search.toLowerCase()) > -1) {
                        return true;
                    } else if (s.name && s.name.toLowerCase().indexOf($scope.search.toLowerCase()) > -1) {
                        return true;
                    } else if (s.preacher && s.preacher.toLowerCase().indexOf($scope.search.toLowerCase()) > -1) {
                        return true;
                    }
                    // s.date vergleichen
                }
